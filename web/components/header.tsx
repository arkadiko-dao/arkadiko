            ...
            <div className="flex justify-between h-16">
              <div className="flex justify-between flex-1">
                <RouterLink className="flex items-center flex-shrink-0" to="/">
                  <img className="w-auto h-6 lg:block sm:h-8" src="/assets/logo.svg" alt="Arkadiko" />
                  <span className="inline-block ml-2 text-lg font-bold align-middle font-headings">Arkadiko</span>
                </RouterLink>
                {state.userData ? (
                  <div className="hidden lg:ml-6 lg:flex lg:space-x-6">
                    <RouterLink to="/pool" className="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:border-gray-300 hover:text-gray-700" activeClassName="border-indigo-500 text-gray-900">Swap</RouterLink>
                    ...
                    <RouterLink to="/auctions" exact className="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:border-gray-300 hover:text-gray-700" activeClassName="border-indigo-500 text-gray-900">Auctions</RouterLink>
                    ...
                    <RouterLink to="/governance" className="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:border-gray-300 hover:text-gray-700" activeClassName="border-indigo-500 text-gray-900">Governance</RouterLink>
                    
                    <a className="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:border-gray-300 hover:text-gray-700" href="https://docs.arkadiko.finance/" target="_blank" rel="noopener noreferrer">
                      Docs
                      <ExternalLinkIcon className="block w-3 h-3 ml-2" aria-hidden="true" />
                    </a>
                    
                    <a className="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:border-gray-300 hover:text-gray-700" href="https://github.com/arkadiko-dao/arkadiko/blob/master/SECURITY.md" target="_blank" rel="noopener noreferrer">
                      Security
                      <ExternalLinkIcon className="block w-3 h-3 ml-2" aria-hidden="true" />
                    </a>
                ...
                <div className="hidden lg:ml-6 lg:flex lg:space-x-6 lg:items-center">
                  <div className="sm:flex sm:space-x-8 sm:h-full">
                    <a className="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:border-gray-300 hover:text-gray-700" href="https://docs.arkadiko.finance/" target="_blank">
                      Docs
                      <ExternalLinkIcon className="block w-3 h-3 ml-2" aria-hidden="true" />
                    </a>
                  
                    <a className="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:border-gray-300 hover:text-gray-700" href="https://github.com/arkadiko-dao/arkadiko/blob/master/SECURITY.md" target="_blank">
                      Security
                      <ExternalLinkIcon className="block w-3 h-3 ml-2" aria-hidden="true" />
                    </a>
                  </div>
            ...
            {state.userData ? (
              <div>
                <div className="pt-2 pb-3 space-y-1">
                  <RouterLink to="/pool" className="block py-2 pl-3 pr-4 text-base font-medium text-gray-500 border-l-4 border-transparent hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700" activeClassName="border-indigo-500 text-gray-900">Swap</RouterLink>
                  ...
                  <RouterLink to="/auctions" exact className="block py-2 pl-3 pr-4 text-base font-medium text-gray-500 border-l-4 border-transparent hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700" activeClassName="border-indigo-500 text-gray-900">Auctions</RouterLink>
                  ...
                  <RouterLink to="/governance" className="block py-2 pl-3 pr-4 text-base font-medium text-gray-500 border-l-4 border-transparent hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700" activeClassName="border-indigo-500 text-gray-900">Governance</RouterLink>
