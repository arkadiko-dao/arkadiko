    ...
    <>
      <div className="w-full min-h-screen overflow-hidden bg-gray-100">
        ...
        <div className="max-w-lg mx-auto mt-8">
          <main>
            <h1 className="mb-8 text-4xl font-bold text-center font-headings">That's it! You're all set! 🚀</h1>
            <div className="text-center">
              <p>Congratulations! You reached the end. Start using the app now and enjoy those self-repaying loans!</p>
              ...
              <p className="mt-12">Got more questions? Feel free to join the community, connect with thousands of people and ask away!</p>
              ...
              <p className="mt-8 text-center">
                <RouterLink to="/onboarding/step-1-swap" className="inline-flex items-center text-xs font-medium text-gray-700 hover:text-gray-900">Retake the onboarding</RouterLink>
              </p>
            </div>
