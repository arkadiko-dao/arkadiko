  ...
  const STEPS_LIST_A = [
    {
      ...
      stepDescription:
        'Different collateral types have different risks, such as when you can get liquidated and how much interest (stability fees) you are paying on your minted USDA.',
    },
  ];
  ...
  const STEPS_LIST_B = [
    {
      ...
      stepDescription:
        'The more collateral you deposit, the more yield you will earn and the more USDA you will be able to borrow!',
    },
    {
      stepWrapperPosition: 'top-0 left-0',
    ...
    },
    {
      ...
      stepDescription:
        'Make sure you are comfortable with the collateralization and liquidation prices. You can always return some USDA or deposit extra STX to make ratios healthier!',
    },
  ];
  ...
  const STEPS_LIST_C = [
    {
      ...
      stepDescription:
        'Indicate whether you would like your STX tokens to earn a yield and whether you want your yield to automatically pay off the USDA debt you are minting.',
    },
    {
      stepWrapperPosition: 'bottom-0 right-0',
            ...
            <div className="relative max-w-[1000px] mx-auto">
              {currentStep >= 0 && currentStep < 2 ? (
                <>
                  <img
                    ...
                    src="/assets/onboarding/vaults-1.png"
                    alt=""
                  />
              ...
              {currentStep >= 2 && currentStep < 5 ? (
                <>
                  <img
                    ...
                    src="/assets/onboarding/vaults-2.jpeg"
                    alt=""
                  />
              ...
              {currentStep >= 5 ? (
                <>
                  <img
                    className="mt-8 border border-gray-100 rounded-md shadow"
                    src="/assets/onboarding/vaults-3.png"
                    alt=""
                  />
