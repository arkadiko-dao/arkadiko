...
export const OnboardingStep4Governance = () => {
  ...
  const STEPS_LIST_A = [
    {
      ...
      stepDescription:
        'All running proposals will show up with their title clearly visible, indicating the change that a contributor wants to make.',
    },
    {
      stepWrapperPosition: 'top-0 left-0',
      ...
      stepDescription:
        'Indicates the on-chain STX address of the person or entity proposing a change',
    },
    {
      stepWrapperPosition: 'top-0 left-0',
      ...
      stepDescription:
        'Indicates whether the proposal is already open for voting or is still pending.',
    },
    {
      stepWrapperPosition: 'top-0 left-0',
      ...
      stepDescription:
        'Time on the Stacks blockchain runs in number of blocks. You will be able to vote on a proposal until the indicated block height is reached.',
    },
  ];
  ...
  const STEPS_LIST_B = [
    ...
    },
    {
      ...
      stepDescription:
        'Use your tokens to show your support for proposals you believe in, or block proposals that might be detrimental!',
    },
    {
      stepWrapperPosition: 'top-0 left-0',
      stepPosition: 'top-[310px] left-[947px]',
      ...
      stepDescription:
        'This indicates whether or not a governance proposal will be adopted when the closing block height is reached',
    },
  ];
    ...
    <>
      {currentStep === 0 ? (
        <StepIntroduction
          ...
          stepDescription={
            'Have your say in the future direction of your protocol by participating in Arkadiko Governance!'
          }
        />
      ) : null}
          ...
          <main className="pt-12 pb-12 sm:pt-0">
            ...
            <div className="relative max-w-[1000px] mx-auto">
                ...
                <>
                  <img
                    className={classNames(
                      currentStep === 0 ? 'filter blur transition duration-200 ease-in-out' : '',
                      'mt-8 border border-gray-100 rounded-md shadow'
                    )}
                    src="/assets/onboarding/governance-1.jpeg"
                    alt=""
                  />
              ...
              {currentStep >= 5 ? (
                <>
                  <img
                    className="mt-8 border border-gray-100 rounded-md shadow"
                    src="/assets/onboarding/governance-2.jpeg"
                    alt=""
                  />
