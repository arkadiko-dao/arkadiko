  ...
  const STEPS_LIST = [
    {
      ...
      stepDescription:
        'Select the token pair you would like to trade on. We support DIKO/USDA, DIKO/STX and STX/USDA with more pairs to come soon!',
    },
    {
      ...
      stepDescription:
        'Type the amount of tokens you would like to swap. The approximate amount of tokens you will receive will be filled in automatically based on the current market price.',
    },
    {
      stepWrapperPosition: 'top-0 left-0',
      ...
      stepDescription:
        'If you want to be absolutely sure your transaction will confirm, you can adjust the slippage. This allows you to pay a higher fee for more certainty, but you might receive a little less tokens.',
    },
    {
      stepWrapperPosition: 'top-0 left-0',
      ...
      stepTitle: 'Swap',
      stepDescription:
        "Once ready, click the 'Swap' button. You will receive your tokens once the transaction confirms (typically around 10-15 minutes).",
    },
  ];
    ...
    <>
      {currentStep === 0 ? (
        <StepIntroduction
          ...
          stepTitle={'Swap'}
          stepDescription={
            'A permissionless and decentralised way to swap your favorite tokens on the Arkadiko Decentralized Exchange, all on top of the Stacks blockchain.'
          }
        />
      ) : null}
