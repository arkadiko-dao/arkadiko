  ...
  const STEPS_LIST_A = [
    {
      ...
      stepTitle: 'Cooldown',
      stepDescription:
        'A cooldown of 10 days applies when you are withdrawing your DIKO from the single-asset DIKO staking pool. This cooldown does not apply for LP token staking.',
    },
    {
      stepWrapperPosition: 'top-0 left-0',
      ...
      stepDescription:
        'The current APR indicates your returns on the amount you are currently staking.',
    },
  ];
  ...
  const STEPS_LIST_B = [
    {
      ...
      stepDescription:
        'The amount of tokens that will be sent to your wallet once you claim them or you withdraw from staking. The single-asset DIKO staking pool automatically compounds your rewards. The LP token pools require manual claims & compounding. ',
    },
    {
      stepWrapperPosition: 'top-0 left-0',
    ...
    <>
      {currentStep === 0 ? (
        <StepIntroduction
          ...
          stepTitle={'Staking'}
          stepDescription={
            'Staking is the perfect way to earn extra DIKO and participate in liquidity mining!'
          }
        />
      ) : null}
              ...
              {currentStep >= 0 && currentStep < 3 ? (
                <>
                  <img
                    ...
                    src="/assets/onboarding/staking-1.jpeg"
                    alt=""
                  />
