...
export const Swap: React.FC = () => {
  ...
  return (
    <>
      ...
      <Container>
        <a href="" className="group px-4 px-6 py-6 mx-auto my-3 border-2 border-double border-white/50 rounded-md max-w-5xl lg:px-8 bg-gradient-to-r from-[#0a3931] to-indigo-900 flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="font-semibold text-white sm:text-xl font-headings">
              ...
              USDC on Bitflow
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="inline w-5 h-5 ml-2 transition duration-200 ease-out group-hover:translate-x-2">
