        ...
        <div className="pr-16 sm:text-center sm:px-16">
          <p className="text-white">
            ...
            <span className="space-y-1 sm:space-y-0 sm:space-x-6">
              ...
              <span className="text-sm block sm:mt-0 sm:inline-block">
                <span className="font-semibold">{(parseFloat(state.balance['xbtc']) / 100000000).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 6 })}</span> <span className="opacity-75">xBTC</span>
              </span>
              <span className="text-sm block sm:mt-0 sm:inline-block">
