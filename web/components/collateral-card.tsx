          ...
          <div className="relative">
            ...
            <div className="absolute flex items-center p-6 -translate-x-1/2 -translate-y-1/2 bg-white border border-gray-200 rounded-md dark:border-zinc-600 top-1/2 justity-center left-1/2">
              <div className="text-lg text-center">
                ...
                <p className="text-sm">
                  <a className="font-medium text-indigo-500 hover:text-indigo-700" target="_blank" href="https://twitter.com/ArkadikoFinance/status/1769034597394710594">Learn more</a>
                </p>
              </div>
            </div>
          </div>
