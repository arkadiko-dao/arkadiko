...
export const SwapLoadingPlaceholder: React.FC = ({ tokenX, tokenY }) => {
  return (
    <>
      <div>
        <div className="border border-gray-200 rounded-md shadow-sm bg-gray-50 hover:border-gray-300 focus-within:border-indigo-200 h-[104px] dark:border-zinc-800 dark:bg-zinc-700 dark:border-zinc-900">
        ...
        <div className="relative z-10 flex items-center justify-center w-8 h-8 -mt-4 -mb-4 -ml-4 text-gray-400 transform bg-white border border-gray-300 rounded-md left-1/2 dark:bg-zinc-700 dark:border-zinc-800">
          <SwitchVerticalIcon className="w-5 h-5" aria-hidden="true" />
        </div>

        <div className="mt-1 border border-gray-200 rounded-md shadow-sm bg-gray-50 hover:border-gray-300 focus-within:border-indigo-200 h-[104px] dark:border-zinc-800 dark:bg-zinc-700 dark:border-zinc-900">
          <div className="flex items-center p-4 pb-2">
