      ...
      <div className="relative z-10 w-full max-w-lg bg-white rounded-lg shadow">
        <div className="flex flex-col p-4">
          <div className="flex mb-4 space-x-4">
            <span className="px-3 py-2 text-lg text-indigo-700 bg-indigo-100 rounded-md font-headings">Swap</span>
            <span className="px-3 py-2 text-lg text-gray-500 rounded-md hover:text-gray-700 font-headings">Pool</span>
          </div>
          <div>
