class PoxCalculator
  def self.calculate_yields(names: ['stacker'], file: 'vaults-pox-29.json', ustx_stacked: 8_231_499_178_226, ustx_yield: 33_430_113_300)
  ...
  def self.build_clarity_list_tuples(names:, file: 'vaults-pox-29.json')
