...
(begin
  ...
  ;; DIKO pool - New
  (map-set pools-data-map
    { pool: 'ST26902A6NT1QSWQXXYM55EM579RY9CCPQDN02QW2.arkadiko-stake-pool-diko-tv1-1 }
    {
      name: "DIKO",
  ...
  ;; DIKO-USDA LP - Old
  (map-set pools-data-map
    { pool: 'ST26902A6NT1QSWQXXYM55EM579RY9CCPQDN02QW2.arkadiko-stake-pool-diko-usda-v1-1 }
    {
      name: "DIKO-USDA LP",
      deactivated-block: u2000,
  ...
  ;; DIKO-USDA LP - New
  (map-set pools-data-map
    { pool: 'ST26902A6NT1QSWQXXYM55EM579RY9CCPQDN02QW2.arkadiko-stake-pool-diko-usda-tv1-1 }
    {
      name: "DIKO-USDA LP",
      deactivated-block: u0,
      deactivated-rewards-per-block: u0,
  ...
  ;; wSTX-USDA LP
  (map-set pools-data-map
    { pool: 'ST26902A6NT1QSWQXXYM55EM579RY9CCPQDN02QW2.arkadiko-stake-pool-wstx-usda-v1-1 }
    {
      name: "wSTX-USDA LP",
      deactivated-block: u0,
      deactivated-rewards-per-block: u0,
