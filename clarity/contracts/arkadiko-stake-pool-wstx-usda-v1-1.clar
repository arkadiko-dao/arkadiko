;; Stake Pool - Stake wSTX-USDA LP tokens
;; 
...
(define-read-only (calculate-cumm-reward-per-stake)
  (let (
    (rewards-per-block (contract-call? .arkadiko-stake-registry-v1-1 get-rewards-per-block-for-pool .arkadiko-stake-pool-wstx-usda-v1-1))
...
(define-private (get-last-block-height)
  (let (
    ...
    (pool-data (contract-call? .arkadiko-stake-registry-v1-1 get-pool-data .arkadiko-stake-pool-wstx-usda-v1-1))
