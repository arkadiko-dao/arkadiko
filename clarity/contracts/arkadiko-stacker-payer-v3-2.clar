...
(begin
  ...
  (map-set vaults-redeemed { vault-id: 360 } { redeemed: true })
  (map-set vaults-redeemed { vault-id: 353 } { redeemed: true })
  (map-set vaults-redeemed { vault-id: 309 } { redeemed: true })
  (map-set vaults-redeemed { vault-id: 296 } { redeemed: true })
  (map-set vaults-redeemed { vault-id: 294 } { redeemed: true })
  (map-set vaults-redeemed { vault-id: 163 } { redeemed: true })
  (map-set vaults-redeemed { vault-id: 34 } { redeemed: true })
  (map-set vaults-redeemed { vault-id: 31 } { redeemed: true })
  (map-set vaults-redeemed { vault-id: 26 } { redeemed: true })
  (map-set vaults-redeemed { vault-id: 1157 } { redeemed: true })
  (map-set vaults-redeemed { vault-id: 1131 } { redeemed: true })
  (map-set vaults-redeemed { vault-id: 182 } { redeemed: true })
  (map-set vaults-redeemed { vault-id: 1562 } { redeemed: true })
  (map-set vaults-redeemed { vault-id: 819 } { redeemed: true })
)
