...
Clarinet.test({
  ...
  async fn(chain: Chain, accounts: Map<string, Account>) {
    ...
    // Get pool info
    let call:any = stakeRegistry.getPoolData('arkadiko-stake-pool-diko-usda-v1-2');
  ...
  async fn(chain: Chain, accounts: Map<string, Account>) {
    ...
    let block = chain.mineBlock([
      Tx.contractCall("arkadiko-stake-registry-v2-1", "set-pool-data", [
        types.principal('ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.arkadiko-stake-pool-wstx-usda-v1-2'),
        types.ascii("test"),
        types.uint(1),
        types.uint(0),
        types.uint(0)
...
async fn(chain: Chain, accounts: Map<string, Account>) {
  ...
  // Unstake funds
  result = stakeRegistry.unstake(deployer, "arkadiko-stake-pool-diko-usda-v1-2", "arkadiko-swap-token-diko-usda", 223.606797)
  result.expectOk().expectUintWithDecimals(223.606797);
...
async fn(chain: Chain, accounts: Map<string, Account>) {
  ...
  // Stake - Wallet 2
  result = stakeRegistry.stake(wallet_2, "arkadiko-stake-pool-diko-usda-v1-2", "arkadiko-swap-token-diko-usda", 200)
  ...
  call = stakeRegistry.getPendingRewards(wallet_2, "arkadiko-stake-pool-diko-usda-v1-2");
  ...
  // Unstake funds
  result = stakeRegistry.unstake(deployer, "arkadiko-stake-pool-diko-usda-v1-2", "arkadiko-swap-token-diko-usda", 100)
...
async fn(chain: Chain, accounts: Map<string, Account>) {
  ...
  // Claim
  result = stakeRegistry.claimRewards(deployer, "arkadiko-stake-pool-diko-usda-v1-2");
...
Clarinet.test({
  ...
  async fn(chain: Chain, accounts: Map<string, Account>) {
    ...
    // Stake
    result = stakeRegistry.stake(deployer, "arkadiko-stake-pool-diko-usda-v1-2", "arkadiko-swap-token-diko-usda", 100)
    result.expectOk().expectUintWithDecimals(100);
    ...
    result = stakeRegistry.stakePendingRewards(deployer, "arkadiko-stake-pool-diko-usda-v1-2");
    ...
    result.expectOk().expectUintWithDecimals(4436.993381);
...
async fn(chain: Chain, accounts: Map<string, Account>) {
  ...
  block = chain.mineBlock([
    Tx.contractCall("arkadiko-stake-pool-diko-usda-v1-2", "stake", [
      types.principal(Utils.qualifiedName('arkadiko-stake-registry-v2-1')),
      types.principal(Utils.qualifiedName('arkadiko-swap-token-diko-usda')),
      types.principal(Utils.qualifiedName('arkadiko-swap-token-diko-usda')),
      types.uint(100)
  ...
  block = chain.mineBlock([
    Tx.contractCall("arkadiko-stake-pool-diko-usda-v1-2", "unstake", [
      types.principal(Utils.qualifiedName('arkadiko-stake-registry-v2-1')),
      types.principal(Utils.qualifiedName('arkadiko-swap-token-diko-usda')),
      types.principal(Utils.qualifiedName('arkadiko-swap-token-diko-usda')),
      types.uint(100)
  ...
  block = chain.mineBlock([
    Tx.contractCall("arkadiko-stake-pool-diko-usda-v1-2", "claim-pending-rewards", [
      types.principal(Utils.qualifiedName('arkadiko-stake-registry-v2-1')),
...
async fn(chain: Chain, accounts: Map<string, Account>) {
  ...
  // Stake
  let result = stakeRegistry.stake(wallet_1, "arkadiko-stake-pool-diko-usda-v1-2", "arkadiko-swap-token-diko-usda", 1500000)
  result.expectErr().expectUint(1);
}
});
...
async fn(chain: Chain, accounts: Map<string, Account>) {
  ...
  // Claim, no rewards
  let result = stakeRegistry.claimRewards(wallet_1, "arkadiko-stake-pool-diko-usda-v1-2");
  result.expectOk().expectUint(0);
}
});
...
async fn(chain: Chain, accounts: Map<string, Account>) {
  ...
  // Unstake funds
  result = stakeRegistry.unstake(deployer, "arkadiko-stake-pool-diko-usda-v1-2", "arkadiko-swap-token-diko-usda", 25000)
...
async fn(chain: Chain, accounts: Map<string, Account>) {
  ...
  // Stake
  let result = stakeRegistry.stake(wallet_1, "arkadiko-stake-pool-diko-usda-v1-2", "arkadiko-swap-token-diko-usda", 0);
  result.expectErr().expectUint(3);
 
  // Unstake funds
  result = stakeRegistry.unstake(wallet_1, "arkadiko-stake-pool-diko-usda-v1-2", "arkadiko-swap-token-diko-usda", 0);
  result.expectErr().expectUint(3);
}
});
...
Clarinet.test({
  ...
  async fn(chain: Chain, accounts: Map<string, Account>) {
    ...
    // Stake funds
    result = stakeRegistry.stake(deployer, "arkadiko-stake-pool-diko-usda-v1-2", "arkadiko-swap-token-diko-usda", 10);
    ...
    // Unstake funds
    result = stakeRegistry.unstake(deployer, "arkadiko-stake-pool-diko-usda-v1-2", "arkadiko-swap-token-diko-usda", 10);
    result.expectOk().expectUintWithDecimals(10);
...
Clarinet.test({
  ...
  async fn(chain: Chain, accounts: Map<string, Account>) {
    ...
    // Emergency withdraw
    block = chain.mineBlock([
      Tx.contractCall("arkadiko-stake-pool-diko-usda-v1-2", "emergency-withdraw", [
        types.principal(Utils.qualifiedName('arkadiko-stake-registry-tv1-1')),
      ], deployer.address)
    ]);
    ...
    block = chain.mineBlock([
      Tx.contractCall("arkadiko-stake-pool-diko-usda-v1-2", "increase-cumm-reward-per-stake", [
        types.principal(Utils.qualifiedName('arkadiko-stake-registry-tv1-1')),
      ], deployer.address)
    ]);
    block.receipts[0].result.expectErr().expectUint(18004);
...
Clarinet.test({
  ...
  async fn(chain: Chain, accounts: Map<string, Account>) {
    ...
    call = dao.getContractCanMint("arkadiko-stake-pool-diko-usda-v1-2");
    call.result.expectBool(true)
    call = dao.getContractCanBurn("arkadiko-stake-pool-diko-usda-v1-2");
    call.result.expectBool(true)
    ...
    call = chain.callReadOnlyFn("arkadiko-stake-pool-diko-usda-v1-2", "get-pending-rewards", [
      types.principal(Utils.qualifiedName('arkadiko-stake-registry-tv1-1')),
      types.principal(deployer.address)
    ], deployer.address);
    call.result.expectOk().expectUintWithDecimals(374711.9176)
...
Clarinet.test({
  ...
  async fn(chain: Chain, accounts: Map<string, Account>) {
    ...
    // Create proposal
    let contractChange1 = Governance.contractChange("stake-registry", Utils.qualifiedName('arkadiko-stake-registry-tv1-1'), true, true);
    let contractChange2 = Governance.contractChange("stake-pool-diko-usda", Utils.qualifiedName('arkadiko-stake-pool-diko-usda-v1-2'), false, true);
...
Clarinet.test({
  ...
  async fn(chain: Chain, accounts: Map<string, Account>) {
    ...
    // Stake funds
    stakeRegistry.stake(deployer, "arkadiko-stake-pool-diko-usda-v1-2", "arkadiko-swap-token-diko-usda", 223.606797)
    ...
    for (let index = 0; index < 390; index++) {
      ...
      let call = stakeRegistry.getPendingRewards(deployer, "arkadiko-stake-pool-diko-usda-v1-2");
...
Clarinet.test({
  ...
  async fn(chain: Chain, accounts: Map<string, Account>) {
    ...
    // Stake funds
    result = stakeRegistry.stake(wallet_2, "arkadiko-stake-pool-diko-usda-v1-2", "arkadiko-swap-token-diko-usda", 50)
    ...
    for (let index = 0; index < 390; index++) {
      ...
      // Check pending rewards
      let callLp1 = stakeRegistry.getPendingRewards(wallet_2, "arkadiko-stake-pool-diko-usda-v1-2");
